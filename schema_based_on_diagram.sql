...
CREATE INDEX treatments_histories_medical_histories_id ON treatments_histories(medical_histories_id);
CREATE INDEX treatments_histories_treatments_id ON treatments_histories(treatments_id);